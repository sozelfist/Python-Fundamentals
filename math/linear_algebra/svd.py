...
def svd(A: np.ndarray) -> tuple:
    ...
    # Compute the matrix S^2 as a diagonal matrix with
    # the eigenvalues as entries
    ...
    U = eigenvectors
    # Compute the matrix V as the matrix of eigenvectors of
    # A_transpose * A with the eigenvalues of S^2
