...
class TestCaesarCipher(unittest.TestCase):
    ...
    def test_encrypt(self):
        ...
        self.assertEqual(caesar_cipher(
            "PYTHON IS GREAT", 7), "WFAOVU PZ NYLHA"
        )
        self.assertEqual(
    ...
    def test_decrypt(self):
        self.assertEqual(caesar_cipher(
            "KHOOR ZRUOG", 3, encrypt=False), "HELLO WORLD")
        self.assertEqual(
            caesar_cipher("WFAOVU PZ NYLHA", 7, encrypt=False),
            "PYTHON IS GREAT"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            caesar_cipher("rovvy gybvn", 10, encrypt=False), "hello world"
        )
        self.assertEqual(caesar_cipher(
            "1234!@#$", 5, encrypt=False), "1234!@#$")
