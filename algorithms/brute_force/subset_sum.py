...
def subset_sum_brute_force(numbers: List[int], target: int) -> List[List[int]]:
    ...
    Returns:
        A list of lists of integers representing all possible subsets of the input list that
        sum to the target value, or an empty list if no such subsets were found.
    """
