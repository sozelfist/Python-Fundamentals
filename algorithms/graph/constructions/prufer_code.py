...
def prufer_code(leaf_nodes: List[int]) -> List[Tuple[int, int]]:
    ...
    Args:
        leaf_nodes (List[int]): A list of indices representing the leaf nodes of the tree.

    Returns:
        List[Tuple[int, int]]: A list of tuples representing the edges of the tree encoded using Prufer code.
    """
...
class TestPruferCode(unittest.TestCase):
    ...
    def test_medium_tree(self):
        ...
        expected_edges = [(3, 4), (1, 5), (0, 1), (0, 6), (3, 0), (2, 7), (9, 8), (9, 10), (2, 9), (3, 2), (3, 11)]
        self.assertEqual(prufer_code(leaf_nodes), expected_edges)
